...
class Position():
    def __init__(self, ticker, date, side, strike, price, closing_trade, short_trade, trader, channel, time):
        self.ticker = ticker
        self.date = date
        self.side = side
        self.strike = strike
    ...
    def copy(self, ticker=None, date=None, side=None, strike=None, price=None, closing_trade=None, short_trade=None, trader=None, channel=None, time=None):
        if ticker == None:
            ticker = self.ticker
        if date == None:
            date = self.date
        ...
        if time == None:
            time = self.time
        return Position(ticker, date, side, strike, price, closing_trade, short_trade, trader, channel, time)
...
class Success_String():
    def __init__(self, response):
        self.response = response
    
    def get_response(self, ticker, date, side, strike, price):
        return self.response.format(ticker=ticker, date=date, side=side, strike=strike, price=price)
