from TDAccount import Trade, Position
...
class TDExecutor():
    ...
    def get_surrounding(td_account, position, strike_count=10, above_below=4):
        ...
        chain = td_account.get_options_chain('DDOG', strike_count=strike_count, from_date=from_date, to_date=to_date, contract_type=side.replace('S', ''))
